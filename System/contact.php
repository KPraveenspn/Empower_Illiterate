...
<head>
	...
	<title>Empower Illiterate - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Integral University, <br/> Kursi road, <br/>Lucknow</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:pravinkumarlko@gmail.com">pravinkumarlko@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Empower Illiterate</h5>
											<p>Empower Illiterate is a job portal, online job management system developed by Praveen, Aarif and Prabal for college project in May 2022.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Empower Illiterate Jobs Contact</h5>
								
								<p>Address : Integral University, kursi road Lucknow</p>
								<p>Email : <a href="mailto:pravinkmarlko@gmail.com">pravinkmarlko@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Empower Illiterate Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Praveen, Aarif and Prabal</a></li>
								</ul>
