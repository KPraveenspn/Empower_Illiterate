...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/logo1.jpg'); width: 1340px; height: 1000px;">
				<div class="container">

					<h1>Empower Illiterate</h1>
					<p>Every One Can Work</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Empower Illiterate Contact</h5>
								
								<p>Address : Integral University, kursi road Lucknow</p>
								<p>Email : <a href="mailto:pravinkumarlko@gmail.com">pravinkmarlko@gmail.com</a></p>
